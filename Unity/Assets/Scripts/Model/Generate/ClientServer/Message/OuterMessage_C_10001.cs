...
namespace ET
{
    ...
    public partial class C2R_LoginAccount : MessageObject, ISessionRequest
    {
        ...
        /// </summary>
        /// <summary>
        /// 在c#Proto2CS，会将proto转至为C#类，为MP使用，MP主要就是快
        /// </summary>
        [MemoryPackOrder(0)]
        public int RpcId { get; set; }
    ...
    [MemoryPackable]
    [Message(OuterMessage.ServerInfosProto)]
    public partial class ServerInfosProto : MessageObject
    {
        public static ServerInfosProto Create(bool isFromPool = false)
        {
            return ObjectPool.Instance.Fetch(typeof(ServerInfosProto), isFromPool) as ServerInfosProto;
        }
    ...
    public partial class R2C_GetServerInfos : MessageObject, ISessionResponse
    {
        ...
        [MemoryPackOrder(3)]
        public List<ServerInfosProto> ServerInfosList { get; set; } = new();
    ...
    [ResponseType(nameof(R2C_CreatRole))]
    ...
    [MemoryPackable]
    [Message(OuterMessage.R2C_CreatRole)]
    public partial class R2C_CreatRole : MessageObject, ISessionResponse
    {
        public static R2C_CreatRole Create(bool isFromPool = false)
        {
            return ObjectPool.Instance.Fetch(typeof(R2C_CreatRole), isFromPool) as R2C_CreatRole;
        }
    ...
    public static class OuterMessage
    {
        ...
        public const ushort TransformInfo = 10012;
        public const ushort M2C_SyncUnitTransforms = 10013;
        ...
        public const ushort C2R_LoginAccount = 10040;
        public const ushort R2C_LoginAccount = 10041;
        public const ushort A2C_Disconnect = 10042;
        public const ushort ServerInfosProto = 10043;
